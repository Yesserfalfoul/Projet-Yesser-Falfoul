					...
					<div class="billing-details">
						...
						<form>
							...
							<select class="form-control">
								...
								<option value="kr">Kairouen</option>
								<option value="ss">Soussa</option>
								<option value="ms">Monastir</option>
								<option value="tz">Touzeur</option>
								<option value="md">Mednin</option>
								<option value="sl">Seliana</option>
								<option value="bz">Benzart</option>
								<option value="kf">Kef</option>
								<option value="sx">Sfax</option>
								<option value="kb">Kbili</option>
								<option value="zg">Zaghouan</option>
								<option value="mb">Manouba</option>
								<option value="ks">Kasrine</option>
			...
			<div class="payment-method">
				<div class="row">
					<form>
						...
						<div class="col-md-4">
							<input name="payment" id="radio3" class="css-checkbox" type="radio"><span>Carte bancaire</span>
							<div class="space20"></div>
				...
				<div class="space30"></div>
				<a href="#" class="button btn-lg">Pay</a>
			</div>
		</div>		
